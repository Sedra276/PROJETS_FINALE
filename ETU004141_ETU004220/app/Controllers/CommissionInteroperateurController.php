...
class CommissionInteroperateurController extends BaseController
{
    ...
    public function store()
    {
        ...
        if (! $this->commissionModel->validate($donnees)) {
            return redirect()->to(site_url('operateur/commissions-interoperateur/creer'))
        ...
        return redirect()->to(site_url('operateur/commissions-interoperateur'))
    ...
    public function update(int $id)
    {
        ...
        if (! $this->commissionModel->validate($donnees)) {
            return redirect()->to(site_url('operateur/commissions-interoperateur/modifier/' . $id))
                ->with('erreurs', $this->commissionModel->errors())
                ->withInput();
        }
